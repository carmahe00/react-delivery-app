...
interface Props {
    order: Order,
    navigation: StackNavigationProp<ClientOrderStackParamList, 'ClientOrderListScreen'>
}
const ClientOrderListItem = ({ order, navigation }: Props) => {
    return (
        <TouchableOpacity onPress={() => navigation.navigate("ClientOrderDetailScreen", {order})} >
